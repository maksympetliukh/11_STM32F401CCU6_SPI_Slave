# SPI Slave on STM32F407VET6

### What this project is
This project was created to learn basic principles, logic and how SPI protocol works.
Learn how to design and develop SPI driver and custom HAL-like library. This project aims to study the slave device.
...
- receive data from master to slave
- send a response from slave to master while receiving dummy bytes
